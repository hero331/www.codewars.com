...
public class cd10 {
    public static void main(String args[]){
        Song mountMoose = new Song("Mount Moose", "The Snazzy Moose");
        // day 1 (or test 1)
        System.out.println(mountMoose.howMany(new ArrayList<String>(Arrays.asList("John", "Fred", "BOb", "carl", "RyAn")))); //=> 5

        // day 2
        System.out.println(mountMoose.howMany(new ArrayList<String>(Arrays.asList("JoHn", "Luke", "AmAndA")))); //=> 2
    }
}
